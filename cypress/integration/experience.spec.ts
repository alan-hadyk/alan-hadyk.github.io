                  ...
                  cy.dataCy("ListItem")
                    .spread((
                      ...
                      cy.get(createScalable)
                        ...
                        .should("contain", "Create scalable and sane front-end architecture");
    
                      cy.get(orchestrateAndDirect)
                        .find("[data-testid='OrchestrateAndDirect']")
                        .should("contain", "Orchestrate and direct collaborative team operational objectives for front-end layer of an application designed to manage payment systems");
    
                      cy.get(applyAndCertify)
                        .find("[data-testid='ApplyAndCertify']")
                        .should("contain", "Apply development and certify adherence to best practices to deliver application based on React.js");
    
                      cy.get(streamlineProjectTimelines)
                        .find("[data-testid='StreamlineProjectTimelines']")
                        .should("contain", "Streamline project timelines to ensure application is being developed");
  
                      cy.get(developApiGateway)
                        .find("[data-testid='DevelopApiGateway']")
                        .should("contain", "Develop API gateway in the form of Express / Node.js server, along with Apollo / GraphQL stack");
    
                      cy.get(transformAndCreate)
                        .find("[data-testid='TransformAndCreate']")
                        .should("contain", "Transform and create reusable components");
  
                      cy.get(authorUnit)
                        .find("[data-testid='AuthorUnit']")
                        .should("contain", "Author unit, integration and acceptance tests");
    
                      cy.get(demonstrateExpertise)
                        .find("[data-testid='DemonstrateExpertise']")
                        .should("contain", "Demonstrate expertise in the utilization of GraphQL to communicate with backend");
                ...
                .within(() => {
                  ...
                  cy.dataCy("ListItem")
                    .spread((
                      ...
                      cy.get(orchestrateAndDirect)
                        .find("[data-testid='OrchestrateAndDirect']")
                        .should("contain", "Orchestrate and direct collaborative team operational objectives for front-end layer of an application designed to manage hotels");
    
                      cy.get(applyAndCertify)
                        .find("[data-testid='ApplyAndCertify']")
                        .should("contain", "Apply development and certify adherence to best practices to deliver PoC based on React.js");
    
                      cy.get(streamlineProjectTimelines)
                        .find("[data-testid='StreamlineProjectTimelines']")
                        .should("contain", "Streamline project timelines to ensure application is being developed in Ember.js with TypeScript");
  
                      cy.get(transformAndCreate)
                        .find("[data-testid='TransformAndCreate']")
                        .should("contain", "Transform and create reusable components and manage adapters, models and serializers");
                      ...
                      cy.get(demonstrateExpertise)
                        .find("[data-testid='DemonstrateExpertise']")
                        .should("contain", "Demonstrate expertise in the utilization of REST to communicate with backend");
                  ...
                  cy.dataCy("ListItem")
                    .spread((
                      ...
                      cy.get(alignedAndBridged)
                        ...
                        .should("contain", "Aligned objectives and bridged communication for UI development and monitoring of various projects and services");
    
                      cy.get(promotedSynchronized)
                        .find("[data-testid='PromotedSynchronized']")
                        .should("contain", "Promoted synchronized communication to produce Agile methodology across projects");
    
                      cy.get(engageAndDeliver)
                        .find("[data-testid='EngageAndDeliver']")
                        .should("contain", "Sought as speaker to engage and deliver university lectures");
  
                      cy.get(navigatedToDrive)
                        .find("[data-testid='NavigatedToDrive']")
                        .should("contain", "Navigated rapidly evolving digital technology landscapes to drive team comprehension of JavaScript frameworks");
  
                      cy.get(enabledTapInto)
                        .find("[data-testid='EnabledTapInto']")
                        .should("contain", "Enabled our product team to tap into valuable data sources and build incredible features for our customers");
                    }); 
                });
            });
        });
                  ...
                  cy.dataCy("ListItem")
                    .spread((
                      ...
                      cy.get(optimizedAndSystematized)
                        ...
                        .should("contain", "Optimized and systematized UI development (and sometimes design) of various e-commerce projects");
    
                      cy.get(bolstered)
                        .find("[data-testid='Bolstered']")
                        .should("contain", "Bolstered continued professional development with concepts and technologies, such as: CSS preprocessors, UI pattern libraries and JavaScript task runners");
    
                      cy.get(presentedInnovative)
                        .find("[data-testid='PresentedInnovative']")
                        .should("contain", "Presented innovative approaches in the form of brown bags to all engineers to help shape our technical market presence");
  
                      cy.get(fosteredCrossFunctional)
                        .find("[data-testid='FosteredCrossFunctional']")
                        .should("contain", "Fostered cross-functional communication with information technology, end users, and other stakeholders to translate needs into system requirements, solid solutions, and reliable results");
  
                      cy.get(informedDecisions)
                        .find("[data-testid='InformedDecisions']")
                        .should("contain", "Informed decisions to incorporate the use of defect and enhancement tracking software and processes");
                    }); 
                });
            });
        });
                  ...
                  cy.dataCy("ListItem")
                    .spread((
                      ...
                      cy.get(employedPersonalReferral)
                        ...
                        .should("contain", "Employed personal referral networks to attain small job order contracts");
    
                      cy.get(initializedPersonalMotivation)
                        .find("[data-testid='InitializedPersonalMotivation']")
                        .should("contain", "Initialized personal motivation to acquire front-end development skills");
    
                      cy.get(cultivatedStrongTies)
                        .find("[data-testid='CultivatedStrongTies']")
                        .should("contain", "Cultivated strong ties to the technology community through exemplified demonstration of abilities");
  
                      cy.get(coordinatedDevelopment)
                        .find("[data-testid='CoordinatedDevelopment']")
                        .should("contain", "Coordinated development of interactive web-based data visualizations, including interactive charts and maps");
                    }); 
                });
            });
        });
