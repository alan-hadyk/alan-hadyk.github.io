...
describe("molecules / HexagonWithDescription", () => {
  test("should have correct structure", () => {
    ...
    expect(HexagonWithDescriptionContainer.children[1]).toEqual(ResponsiveDesktop);
    expect(HexagonWithDescriptionContainer.children[2]).toEqual(ResponsiveTablet);
    expect(HexagonWithDescriptionContainer.children[3]).toEqual(ResponsiveMobile);


    expect(ResponsiveTv.children[0]).toEqual(HexagonWithDescriptionContents[0]);
    expect(ResponsiveDesktop.children[0]).toEqual(HexagonWithDescriptionContents[1]);
    expect(ResponsiveTablet.children[0]).toEqual(HexagonWithDescriptionContents[2]);
    expect(ResponsiveMobile.children[0]).toEqual(HexagonWithDescriptionContents[3]);
  });
      ...
      describe("Props", () => {
        describe("description", () => { 
          test("should render correct content passed via description prop", () => {
            ...
            HexagonWithDescriptionContents.forEach((HexagonWithDescriptionContent: Element) => {
              expect(HexagonWithDescriptionContent.children[1].children[0].textContent).toEqual("Custom text");
            });
          });
        });
        ...
        describe("flexFlow", () => { 
          test("should have row nowrap for first and second element", () => {
            ...
            expect(HexagonWithDescriptionContents[0]).toHaveStyleRule("flex-flow", "row nowrap");
            expect(HexagonWithDescriptionContents[1]).toHaveStyleRule("flex-flow", "row nowrap");
          });
        ...
        describe("marginBottom", () => { 
          test("should have 0 for first and second element", () => {
            ...
            expect(HexagonWithDescriptionContents[0].children[0]).toHaveStyleRule("margin-bottom", "0");
            expect(HexagonWithDescriptionContents[1].children[0]).toHaveStyleRule("margin-bottom", "0");
          });

          test("should have 4.8rem for third and fourth element", () => {
            const { HexagonWithDescriptionContents } = setup();

            expect(HexagonWithDescriptionContents[2].children[0]).toHaveStyleRule("margin-bottom", "4.8rem");
            expect(HexagonWithDescriptionContents[3].children[0]).toHaveStyleRule("margin-bottom", "4.8rem");
          });
        });
        ...
        describe("marginRight", () => { 
          test("should have 4.8rem for first and second element", () => {
            ...
            expect(HexagonWithDescriptionContents[0].children[0]).toHaveStyleRule("margin-right", "4.8rem");
            expect(HexagonWithDescriptionContents[1].children[0]).toHaveStyleRule("margin-right", "4.8rem");
          });

          test("should have 0 for third and fourth element", () => {
            const { HexagonWithDescriptionContents } = setup();

            expect(HexagonWithDescriptionContents[2].children[0]).toHaveStyleRule("margin-right", "0");
            expect(HexagonWithDescriptionContents[3].children[0]).toHaveStyleRule("margin-right", "0");
          });
        });
        ...
        describe("width", () => { 
          test("should have 50% for first and second element", () => {
            ...
            expect(HexagonWithDescriptionContents[0].children[0]).toHaveStyleRule("width", "50%");
