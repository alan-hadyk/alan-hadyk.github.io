...
} from "<organisms>/ProjectDescription/__typings__/ProjectDescriptionButtons.d.ts";
...
describe("organisms / ProjectDescriptionButtons", () => {
  test("should have correct structure", () => {
    ...
    expect(ProjectDescriptionButtonsContainer.children[1]).toEqual(SpacingContainer);
...
type ProjectDescriptionButtonsTestProps = Partial<ProjectDescriptionButtonsProps>;
...
function setup(additionalProps?: ProjectDescriptionButtonsTestProps): Setup {
  ...
  const ProjectDescriptionButtonsContainer: Element = queryByTestId("ProjectDescriptionButtons");
