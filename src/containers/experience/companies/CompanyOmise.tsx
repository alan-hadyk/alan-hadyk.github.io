      ...
      projects={[
        {
          responsibilities: [
            ...
            <span key="Accelerated">
              <strong>Accelerated project timelines by 20%</strong>, ensuring
              the timely development of application features.
            </span>,
            <span key="Developed">
              Developed an API gateway using Express/Node.js server and
              Apollo/GraphQL stack,{" "}
              <strong>
                increasing backend communication efficiency by 30%
              </strong>
              .
            </span>,
            <span key="Created">
              Created reusable components,{" "}
              <strong>reducing development effort by 15%</strong> and enhancing
