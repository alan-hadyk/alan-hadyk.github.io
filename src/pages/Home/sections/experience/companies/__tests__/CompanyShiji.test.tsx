    ...
    describe("iconsWithLabels", () => {
      test("should render correct icons with labels", () => {
        ...
        CompanyDescriptions.forEach((CompanyDescriptions: Element) => {
          ...
          expect(IconsWithLabels.children[1].children[1].textContent).toEqual("Typescript");
          ...
          expect(IconsWithLabels.children[14].children[1].textContent).toEqual("GitLab");
        });
      });
    });
