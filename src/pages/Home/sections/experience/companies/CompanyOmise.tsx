...
const responsibilities: CompanyProps["responsibilities"] = [
  ...
  <span key="apply-and-certify"><strong>Apply</strong> development and <strong>certify</strong> adherence to best practices to deliver application based on React.js</span>, 
  <span key="streamline-project-timelines"><strong>Streamline</strong> project timelines to ensure application is being developed</span>, 
  <span key="develop-api-gateway"><strong>Develop</strong> API gateway in the form of Express / Node.js server, along with Apollo / GraphQL stack</span>, 
  <span key="transform-and-create"><strong>Transform</strong> and <strong>create</strong> reusable components</span>, 
  <span key="author-unit"><strong>Author</strong> unit, integration and acceptance tests</span>, 
  <span key="demonstrate-expertise"><strong>Demonstrate</strong> expertise in the utilization of GraphQL to communicate with backend</span>, 
