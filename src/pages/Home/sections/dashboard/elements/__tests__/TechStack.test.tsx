...
describe("pages / Home / sections / dashboard / elements / TechStack", () => {
  ...
  describe("AnimatedIcons", () => {
    test("should render correct animated icons", () => {
      ...
      expect(AnimatedIcons.children[0]).toHaveStyleRule(
        "align-items",
        "center"
      );
      ...
      expect(
        AnimatedIcons.children[0].children[0].children[0].textContent
      ).toEqual("Icon-React.svg");
      expect(
        AnimatedIcons.children[0].children[1].children[0].textContent
      ).toEqual("Icon-Javascript.svg");
      expect(
        AnimatedIcons.children[0].children[2].children[0].textContent
      ).toEqual("Icon-Typescript.svg");
      expect(
        AnimatedIcons.children[0].children[3].children[0].textContent
      ).toEqual("Icon-Webpack.svg");
      expect(
        AnimatedIcons.children[0].children[4].children[0].textContent
      ).toEqual("Icon-Node.svg");
      expect(
        AnimatedIcons.children[0].children[5].children[0].textContent
      ).toEqual("Icon-Apollo.svg");
      expect(
        AnimatedIcons.children[0].children[6].children[0].textContent
      ).toEqual("Icon-Graphql.svg");
    });
  });
});
...
function setup(): Setup {
  const utils: RenderResult = renderWithTheme(<TechStack />);
